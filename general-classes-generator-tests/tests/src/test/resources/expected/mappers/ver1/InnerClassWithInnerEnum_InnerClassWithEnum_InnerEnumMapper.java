...
public interface InnerClassWithInnerEnum_InnerClassWithEnum_InnerEnumMapper extends
    ...
    default io.github.pinkolik.general_classes_generator.test.ver1.InnerClassWithInnerEnum.InnerClassWithEnum.InnerEnum mapGeneralToVersioned(io.github.pinkolik.general_classes_generator.test.InnerClassWithInnerEnum.InnerClassWithEnum.InnerEnum other) {
        return io.github.pinkolik.general_classes_generator.test.ver1.InnerClassWithInnerEnum.InnerClassWithEnum.InnerEnum.valueOf(other.name());
    }

    default io.github.pinkolik.general_classes_generator.test.InnerClassWithInnerEnum.InnerClassWithEnum.InnerEnum mapVersionedToGeneral(io.github.pinkolik.general_classes_generator.test.ver1.InnerClassWithInnerEnum.InnerClassWithEnum.InnerEnum other) {
